...
function calcRoute() {
    ...
    directionsService.route(request, function (result, status) {
        if (status == google.maps.DirectionsStatus.OK) {
            ...
            $("#output2").html("<div class='alert-info'> Driving distance: " + result.routes[0].legs[0].distance.text + ".</div>");
            ...
            //show error message
            $("#output2").html("<div class='alert-danger'>Could not retrieve driving distance.</div>");
        }
    });
