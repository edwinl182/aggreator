    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="" data-placement="bottom" href="https://twitter.com/CreativeTim" target="_blank" data-original-title="Click here for queries">
              <i class="fas fa-hands-helping"></i> &nbsp;Customer Support
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="" data-placement="bottom" href="https://www.facebook.com/CreativeTim" target="_blank" data-original-title="For the Vendors">
